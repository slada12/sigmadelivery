...
const corsOption = {
  origin: ['https://imperialezpress.com/', 'https://sigmadelivery-frontend-mfh.pages.dev', 'https://sladatransportation.com', 'https://topdovelogistics.online', 'https://cextransport.site/'],
};
