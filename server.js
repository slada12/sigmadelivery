...
const corsOption = {
  origin: ['https://imperialezpress.com', 'https://sigmadelivery-frontend-mfh.pages.dev', 'https://sladatransport.com', 'https://topdovelogistics.site', 'https://crexcent.site', 'https://tesproject.top', 'http://127.0.0.1:5500', 'https://globateesla.site', 'https://elteslaworld.site/'],
};
