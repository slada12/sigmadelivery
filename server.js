...
const corsOption = {
  origin: ['https://topdovestarship.site', 'https://sigmadelivery-frontend-mfh.pages.dev', 'https://sladatransport.com', 'https://topdovelogistics.site', 'https://khamaniexpress.site', 'https://tesproject.top', 'http://127.0.0.1:5500', 'https://globateesla.site', 'https://elteslaworld.site', 'https://speedster.site', 'https://zodster.site','https://eltesworld.site'],
};
